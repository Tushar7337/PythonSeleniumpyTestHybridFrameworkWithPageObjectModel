...
class RegisterPage(BasePage):
    ...
    terms_and_privacy_error_message_xpath = "//div[@id='account-register']/div[1]"
    ...
    email_error_message_xpath = "//input[@id='input-email']/following-sibling::div"
    phone_error_message_xpath = "//input[@id='input-telephone']/following-sibling::div"
    password_error_message_xpath = "//input[@id='input-password']/following-sibling::div"

    def enter_first_name(self,first_name):
        self.type_into_element(first_name,"self.first_name_field_xpath",self.first_name_field_xpath)
    ...
    def enter_phone_number(self,phone):
        self.type_into_element(phone,"phone_number_xpath",self.phone_number_xpath)
    ...
    def enter_confirm_password(self, confirm_password):
        self.type_into_element(confirm_password,"confirm_password_field_xpath",self.confirm_password_field_xpath)
    ...
    def click_terms_and_condition_check_box(self):
        self.element_click("terms_and_condition_name",self.terms_and_condition_name)
        # self.driver.find_element(By.NAME, self.terms_and_condition_name).click()

    def click_on_newsletter_yes_option(self):
        self.element_click("newsletter_yes_option_xpath",self.newsletter_yes_option_xpath)
    ...
    def verify_account_creation(self,expt_txt):
        result = self.retrieve_element_text("account_created_successfully_text_xpath",self.account_created_successfully_text_xpath)
        return result.__eq__(expt_txt)
    ...
    def verify_error_message_for_duplicate_email(self,expt_text):
        result = self.retrieve_element_text("error_message_while_account_creation_xpath",self.error_message_while_account_creation_xpath)
        return result.__contains__(expt_text)
    ...
    def verify_error_message_for_privacy(self,expt_privacy_text):
        result = self.retrieve_element_text("terms_and_privacy_error_message_xpath",self.terms_and_privacy_error_message_xpath)
        return result.__contains__(expt_privacy_text)
        # return (self.driver.find_element(By.XPATH,self.terms_and_privacy_error_message_xpath).text
        # .__contains__(expt_privacy_text))

    def verify_error_for_first_name(self, expt_first_name_txt):
        result = self.retrieve_element_text("first_name_error_message_xpath",self.first_name_error_message_xpath)
        return result.__contains__(expt_first_name_txt)
        # return (self.driver.find_element(By.XPATH, self.first_name_error_message_xpath).text
        # .__contains__(expt_first_name_txt))

    def verify_error_for_last_name(self, expt_last_name_txt):
        result = self.retrieve_element_text("last_name_error_message_xpath",self.last_name_error_message_xpath)
        return result.__contains__(expt_last_name_txt)
        # return (self.driver.find_element(By.XPATH, self.last_name_error_message_xpath).text
        #        .__contains__(expt_last_name_txt))

    def verify_error_for_email(self, expt_email_txt):
        result = self.retrieve_element_text("email_error_message_xpath",self.email_error_message_xpath)
        return result.__contains__(expt_email_txt)
    ...
    def verify_error_for_phone_number(self, expt_phone_txt):
        result = self.retrieve_element_text("phone_error_message_xpath",self.phone_error_message_xpath)
        return result.__contains__(expt_phone_txt)
    ...
    def verify_error_for_password(self, expt_password_txt):
        result = self.retrieve_element_text("password_error_message_xpath",self.password_error_message_xpath)
        return result.__contains__(expt_password_txt)
